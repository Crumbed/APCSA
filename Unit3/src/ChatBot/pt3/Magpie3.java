...
public class Magpie3
{
	...
	public String getResponse(String statement)
	{
		...
		else if (findKeyword(statement, "Mr.") != -1) {
					response = "He sounds like a good teacher.";
				}
		else if (findKeyword(statement, "Ms.") != -1
				|| findKeyword(statement, "Mrs.") != -1) {
					response = "She sounds like a good teacher.";
				}
		else if (findKeyword(statement, "bacon") != -1) {
			response = "I like bacon";
		} else if (findKeyword(statement, "response") != -1) {
			response = "response";
		} else if (findKeyword(statement, "adventure") != -1) {
